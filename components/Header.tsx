  ...
  return (
    <header className="mb-16 flex h-16 w-screen items-center  justify-center pt-16">
      ...
      <nav className="hidden flex-1 items-center justify-center space-x-10 md:ml-16 md:flex">
        { <p>Made with<span role="img" aria-label="heart emoji">❤️</span> by <a href="h" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Developer Santosh</a> </p>
      }
      </nav>
    </header>
  );
